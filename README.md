...
| Oxlint | off | Native SARIF with Sigilix metadata. Opt-in Sigilix-controlled correctness linting for JavaScript and TypeScript; uses runner-owned config and ignores caller Oxlint config. |
